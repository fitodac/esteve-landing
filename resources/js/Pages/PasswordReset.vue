    ...
    <PageLayout>
        <section id="forgot-password">
            <div class="container global">
                <div class="max-w-lg">
                    <h2 class="text-primary-500 text-2xl tracking-tight md:text-4xl mb-4">Recuperar contraseña</h2>

                    <div class="intro">
                        Si ya estás <strong>dado de alta</strong> en Esteve Psiquiatría Legal o ESTEVE ÁGORA<br>
